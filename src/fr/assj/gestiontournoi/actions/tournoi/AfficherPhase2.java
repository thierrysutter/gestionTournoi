 ...
 * 
 * @struts.action path="/tournoi.afficher2"
 * @struts.action-forward name="success" path="/tournoi/afficherPhase2.jsp"
 *
 */
public class AfficherPhase2 extends ActionBase {
	public ActionForward execute(
		...
		try {
			...
			Vector<Match> listeMatchsTournoi = ManagerMatch.trouverMatchsGroupe(connection, codeTournoi, "tournoi");
			Vector<Match> listeMatchsConsolante = ManagerMatch.trouverMatchsGroupe(connection, codeTournoi, "consolante");
